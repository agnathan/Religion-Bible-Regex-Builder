# This Makefile is for the Religion::Bible::Regex::Builder extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Religion/Bible/Regex/Builder.pm]
#     AUTHOR => q[Daniel Holmlund <holmlund.dev@gmail.com>]
#     NAME => q[Religion::Bible::Regex::Builder]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Religion::Bible::Regex::Config=>q[0], version=>q[0] }
#     VERSION_FROM => q[lib/Religion/Bible/Regex/Builder.pm]
#     clean => { FILES=>q[Religion-Bible-Regex-Builder-*] }
...
NAME_SYM = Religion_Bible_Regex_Builder
VERSION = 0.9.2
...
MAKE = make
FULLEXT = Religion/Bible/Regex/Builder
BASEEXT = Builder
PARENT_NAME = Religion::Bible::Regex
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Religion/Bible/Regex/Builder.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Religion/Bible/Regex
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Religion/Bible/Regex
...
TO_INST_PM = lib/Religion/Bible/Regex/Builder.pm

PM_TO_BLIB = lib/Religion/Bible/Regex/Builder.pm \
...
DISTNAME = Religion-Bible-Regex-Builder
DISTVNAME = Religion-Bible-Regex-Builder-0.9.2
...
manifypods : pure_all  \
	lib/Religion/Bible/Regex/Builder.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Religion/Bible/Regex/Builder.pm $(INST_MAN3DIR)/Religion::Bible::Regex::Builder.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  Religion-Bible-Regex-Builder-* blib 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Religion-Bible-Regex-Builder' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.9.2' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            builds regular expressions that match Bible References' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>builds regular expressions that match Bible References</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Religion/Bible/Regex/Builder.pm blib/lib/Religion/Bible/Regex/Builder.pm 
